# Generated by Django 3.2.8 on 2021-10-25 10:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_verifikasi', models.IntegerField(choices=[(0, 'Belum Mengajukan Verifikasi'), (1, 'Mengajukan Verifikasi'), (2, 'Verifikasi Ditolak'), (3, 'Terverifikasi')], default=0)),
                ('proposal', models.FileField(null=True, upload_to='uploads/company_photos/%Y/%m/', validators=[models.validators.validate_pdf_file_extension])),
